    ...
    public class SanPhamDAO implements DAOInterface<SanPhamDTO> {
        ...
        public int insert(SanPhamDTO t) {
            ...
            try {
                ...
                String sql = "INSERT INTO SanPham(MaSp, TenSp, HinhAnh, SoLuongTon, DonGia, DonViTinh, MaLoai, MaHang, TrangThai) "
               + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, 1)";
                ...
                pst.setString(6, t.getDonViTinh());
                pst.setInt(7, t.getMaLoai());
                pst.setInt(8, t.getMaHang());
        ...
        public int update(SanPhamDTO t) {
            ...
            try {
                ...
                String sql = "UPDATE SanPham "
                        + "SET TenSp = ?, HinhAnh = ?, SoLuongTon = ?, DonGia = ?, DonViTinh = ?, MaLoai = ?, MaHang = ? "
